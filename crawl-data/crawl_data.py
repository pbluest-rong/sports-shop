...
CATEGORY_MAPPING = {
    "quan-ao-bong-da": "670f6c5d2f3e4b8a9c1f0258",
    "giay-chay-bo": "670f6c5d2f3e4b8a9c1f0025",
    "pickleball": "670f6c5d2f3e4b8a9c1f0188",
    "quan-ao-bong-chuyen": "670f6c5d2f3e4b8a9c1f0268",
    "bong-ro": "670f6c5d2f3e4b8a9c1f0262",
    "bong-ban": "670f6c5d2f3e4b8a9c1f0182"
...
ANCESTOR_IDS = {
    "670f6c5d2f3e4b8a9c1f0258": [
        {"$oid": "670f6c5d2f3e4b8a9c1f0255"},
        {"$oid": "670f6c5d2f3e4b8a9c1f0254"},
        {"$oid": "670f6c5d2f3e4b8a9c1f0001"}
    ],
    "670f6c5d2f3e4b8a9c1f0025": [
        {"$oid": "670f6c5d2f3e4b8a9c1f0024"},
        {"$oid": "670f6c5d2f3e4b8a9c1f0023"},
        {"$oid": "670f6c5d2f3e4b8a9c1f0001"}
    ],
    "670f6c5d2f3e4b8a9c1f0188": [
        {"$oid": "670f6c5d2f3e4b8a9c1f0186"},
        {"$oid": "670f6c5d2f3e4b8a9c1f0169"},
        {"$oid": "670f6c5d2f3e4b8a9c1f0001"}
    ],
    "670f6c5d2f3e4b8a9c1f0268": [
        {"$oid": "670f6c5d2f3e4b8a9c1f0266"},
        {"$oid": "670f6c5d2f3e4b8a9c1f0254"},
        {"$oid": "670f6c5d2f3e4b8a9c1f0001"}
    ],
    "670f6c5d2f3e4b8a9c1f0262": [
        {"$oid": "670f6c5d2f3e4b8a9c1f0261"},
        {"$oid": "670f6c5d2f3e4b8a9c1f0254"},
        {"$oid": "670f6c5d2f3e4b8a9c1f0001"}
    ],
    "670f6c5d2f3e4b8a9c1f0182": [
        {"$oid": "670f6c5d2f3e4b8a9c1f0181"},
        {"$oid": "670f6c5d2f3e4b8a9c1f0169"},
        {"$oid": "670f6c5d2f3e4b8a9c1f0001"}
    ]
}
...
def get_product_detail(url):
    try:
        ...
        # Mô tả ngắn
        short_description = soup.select_one(".product-summary .rte").get_text(" ", strip=True) if soup.select_one(".product-summary .rte") else ""

        # Mô tả chi tiết- dạng HTML
        long_description = ""
        content_div = soup.select_one(".product_getcontent #content")
        if content_div:
            long_description = content_div.decode_contents().strip()
...
def normalize_product(detail, category_slug):
    ...
    normalized = {
        ...
        "shortDescription": detail.get("short_description", ""),
        "longDescription": detail.get("long_description", ""),
        "brand": detail.get("brand", ""),
        "status": detail.get("status", "Còn hàng"),
        "sold": 10,
        "categoryId": {"$oid": category_id},
        "ancestorIds": ANCESTOR_IDS.get(category_id, []),
        "attributes": {
            "colors": [],
            "sizes": []
        },
...
products, inventory_sql = crawl_category(CATEGORY_URL, category_slug, start_page=1, end_page=1)

with open("products/" + category_slug + "new.json", "w", encoding="utf-8") as f:
    json.dump(products, f, indent=4, ensure_ascii=False)

with open("products/"+category_slug +"_inventorynew.sql", "w", encoding="utf-8") as f:
    f.write("\n".join(inventory_sql))

print(f"\n✅ Đã lưu {len(products)} sản phẩm vào products/{category_slug}.json")
print(f"✅ Đã sinh {len(inventory_sql)} câu lệnh INSERT vào products/"+category_slug +"_inventory.sql")